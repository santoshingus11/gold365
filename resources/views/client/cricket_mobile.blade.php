                                                                        ...
                                                                        <div><!---->
                                                                            ...
                                                                            <div class="game-list pt-1 pb-1 container-fluid"><a href="https://gold365.art/m/game-detail/28529194">
                                                                                    <div class="row row5">
                                                                                        @if($r['status']==1)
                                                                                        <div class="col-8">
                                                                                            <a href="{{route('Cricket-details',$r['id'])}}" class="mb-0 game-name"><strong>{{$r['game_title']}} / {{date('M d Y h:i A', strtotime($r['created_at']))}} (IST)</strong></a>
                                                                                ...
                                                                                <div class="row row5">
                                                                                    <div class="col-12">
                                                                                        @if($r['status']==1)
                                                                                        <div class="text-center game-col game-home"><a href="{{ route('Cricket-details',$r['id']) }}" class="btn-back">-
                                                                                            </a><a href="{{ route('Cricket-details',$r['id']) }}" class="btn-lay">-</a></div>
                                                                                        <div class="text-center game-col game-home"><a href="{{ route('Cricket-details',$r['id']) }}" class="btn-back">-</a><a href="{{ route('Cricket-details',$r['id']) }}" class="btn-lay">-</a></div>
                                                                                        <div class="text-center game-col game-home"><a href="{{ route('Cricket-details',$r['id']) }}" class="btn-back">-</a><a href="{{ route('Cricket-details',$r['id']) }}" class="btn-lay">-</a></div>
                                                                                        @else
                                    ...
                                    <div class="tab-pane active casino-tables">
                                        <div class="container-fluid">
                                            ...
                                            <div class="col-3 text-center">
                                                    <div class="casinoicons"><a href="/slot/game/lounch/{{$d->id}}"><img class="img-fluid" style="height: 89px;" src="{{$d->img}}">
                                                            <div class="casino-name">{{$d->name}}</div>
                                                        </a></div>
                                                </div>
                                                @endforeach
                                            </div>
