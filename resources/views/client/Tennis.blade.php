                ...
                <table class="table coupon-table">
                  ...
                  @foreach($allGames['tennises'] as $r)
                    <tr>
                      <td>
                         @if($r['status']==1)
                        <div class="game-name"><!----><a href="{{route('tenis_detail',$r['id'])}}" class="text-dark">{{$r['game_title']}} / {{date('M d Y h:i A', strtotime($r['created_at']))}} (IST)</a><!----><!----></div>
                        @else
                        <div class="game-name"><!----><p class="text-dark">{{$r['game_title']}} / {{date('M d Y h:i A', strtotime($r['created_at']))}} (IST)</p><!----><!----></div>
                        @endif
                      ...
                      <td><a href="{{ route('tenis_detail',$r['id']) }}"><button class="back"><span class="odd">2.4 </span></button></a></td>
                      <td><a href="{{ route('tenis_detail',$r['id']) }}"><button class="lay"><span class="odd">1.8</span></button></a></td>
                      <td><a href="{{ route('tenis_detail',$r['id']) }}"><button class="back"><span class="odd">3.5</span></button></a></td>
                      <td><a href="{{ route('tenis_detail',$r['id']) }}"><button class="lay"><span class="odd">1.9</span></button></a></td>
                      <td><a href="{{ route('tenis_detail',$r['id']) }}"><button class="back"><span class="odd">4.6</span></button></a></td>
                      <td><a href="{{ route('tenis_detail',$r['id']) }}"><button class="lay"><span class="odd">3.4</span></button></a></td>
