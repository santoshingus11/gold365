          ...
          <div class="Home_pages_main_section mybets">
            ...
            <div class="row mb-4">
              ...
              <div class="col-lg-12 col-md-12 col-sm-12">
                ...
                <form action="{{route('submit.change.pass')}}" method="POST" >
                    @csrf
                  <div class="row">
                    <div class="col-lg-3">
                      <label for="fromDate" class="col-12 col-form-label">Old Password:</label>
                      <input name="oldPassword" type="password"  autocomplete="off" placeholder="Old Password" class="mx-input w-100">
                    </div>
                    <div class="col-lg-3">
                      <label for="toDate" class="col-12 col-form-label">New Password</label>
                      <input name="newPassword" type="password"  autocomplete="off" placeholder="New Password" class="mx-input w-100">
                    </div>
                    <div class="col-lg-3">
                      <label for="toDate" class="col-12 col-form-label">Repeat Password</label>
                      <input name="confirmPassword" type="password"  autocomplete="off" placeholder="Repeat Password" class="mx-input w-100">
                    </div>
                    <div class="col-lg-2">
                      <label for="toDate" class="col-12 col-form-label w-100 height-24"></label>
                      <button class="btn btn-primary" style="height: 35px;" type="submit">Save</button>
                    </div>
                  </div>
                </form>
                </div>
