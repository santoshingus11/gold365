  ...
  <div class="main_menu">
    ...
    <nav class="navbar navbar-expand-lg bg-black ">
      <div class="container-fluid hideForWeb">
        <div class="d-flex">
          <a class="navbar-brand" href="{{route('cricket-frontend')}}"><img src="{{asset('frontend/assets/images/logo-login.png')}}" alt="logo" class="img-fluid" /></a>
    ...
    <div class="container-fluid">
      ...
      <div class="" id="navbarSupportedContent" style="max-width: 100%;">
        <ul class="d-flex justify-content-around navb" style="overflow-x: auto;">
          <li class="nav-item col-auto p-2"><a href="{{route('cricket-frontend')}}" class="nav-link"> <span class="link-name">HOME</span></a></li>
          <li class="nav-item col-auto p-2"><a href="{{route('cricket-frontend')}}" class="nav-link"> <span class="link-name">IPL 2024</span></a></li>
          <li class="nav-item col-auto p-2"><a href="{{route('client.casino')}}" class="nav-link"> <span class="link-name">LOK SABHA 2024</span></a></li>
          <li class="nav-item col-auto p-2"><a href="{{route('cricket-frontend')}}" class="nav-link"> <span class="link-name">CRICKET</span></a></li>
          <li class="nav-item col-auto p-2"><a href="{{route('football-frontend')}}" class="nav-link"><span class="link-name">FOOTBALL</span></a></li>
          <li class="nav-item col-auto p-2"><a href="{{route('tennis-frontend')}}" class="nav-link"> <span class="link-name">TENNIS</span></a></li>
          <li class="nav-item col-auto p-2"><a href="{{route('horse')}}" class="nav-link"> <span class="link-name">HORSE RACING</span></a></li>
          <li class="nav-item col-auto p-2"><a href="{{route('greyhound')}}" class="nav-link"> <span class="link-name">GREYHOUND RACING</span></a></li>
          <li class="nav-item col-auto p-2"><a href="{{route('arts-frontend')}}" class="nav-link"><span class="link-name">KABADI</span></a></li>
          <li class="nav-item col-auto p-2"><a href="{{route('Motor-Sport-frontend')}}" class="nav-link"> <span class="link-name">POLITICS</span></a></li>
          <li class="nav-item col-auto p-2"><a href="{{route('basketball-frontend')}}" class="nav-link"><span class="link-name">SPORTS BOOK</span></a></li>
          <!--<li class="nav-item col-auto p-2"><a href="{{route('election2023-frontend')}}" class="nav-link download-apk"> <span class="link-name">CASINO</span></a></li>-->
          ...
          <li class="nav-item col-auto p-2"><a href="{{route('client.casino')}}" class="nav-link download-apk"> <span class="link-name">CASINO</span></a></li>
